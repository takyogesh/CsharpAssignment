...
namespace Handler
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Updating Employee with EmployeeId 3");
            obj.Update(3, new Employee { Name = "Akash", Address = "Mumbai" });
            PrintAllEmployees();

            Console.WriteLine("Retrieving Employee details for EmployeeId 3");
            var employee = obj.GetEmplpoyeeById(2);
            Console.WriteLine($"Employee Name of employee ID 3 is {employee.Name}");
